...
const RoomDetailsEmp = (props) => {
    ...
    const handleSubmit = () => {
        ...
        ManagerService.bookRoom(id,booking).then(response => {
        }
        )
            .catch(function (ex) {
                console.log('Response parsing failed. Error: ', ex);
            ...
            <div>
                <form onSubmit={handleSubmit}>
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Customer ID" name="customer" value={customer} onChange={(e)=>onInputChange(e)}/>
                    </div>
                    <div class="form-group">
