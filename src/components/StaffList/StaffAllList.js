...
class StaffAllList extends Component
{
    ...
    componentDidMount() {
        console.log("water");
        AdminService.getAllStaffList().then(response => {
                ...
                <tbody>
                    {
                        this.state.emps.map(emp => 
                            <tr>
                                <td><Link to={`/admin/staffdetails/${emp.employeeId}`}>{emp.employeeId}</Link></td>
                                <td>{emp.name}</td>
                                <td>{emp.email}</td>
                                <td>{emp.mobileNo}</td>
                                <td>{emp.address}</td>
